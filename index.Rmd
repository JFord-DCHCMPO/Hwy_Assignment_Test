...
bins = c(0,500,2500,5000,10000,25000,50000,125000)

volume_pal <- colorBin(palette="GnOrRd", na.color="#808080", domain=g2$Total_Flow_Daily, bins = bins)
...
Volume to Capacity Ratio {.storyboard data-icon="ion-car-outline"}
=====================================  
